...
public class ClientDatagramCache extends Thread
{
	...
	public ClientDatagramCache(ClientVideoPlayer player)
	{
		this.player = player;
	...
	public synchronized void put(DatagramPacket packet)
	{
		...
		if(!started)
		{
			timer.schedule(new TimerTask()
			{
				@Override
		  		public void run()
		  		{
		  			ClientDatagramCache.this.start();
				}
			}, 3*1000);

//jc776: Changes to generated file -
...
int main(int argc, char *argv[]) {
   ...
   //-> /home/jack/Desktop/Project/repos/ns-allinone-3.15/ns-3.15/examples/blackadder-jc776/conf/ns3_topology1/
   std::string path = aux.substr(0,pos+1) + "../../../examples/blackadder-jc776/conf/ns3_topology1/";
   
   Ptr<Node> node0 = CreateObject<Node>();
   Ptr<PointToPointNetDevice> dev0_0 = Create<PointToPointNetDevice>();
   dev0_0->SetAddress (Mac48Address("7f:67:12:b2:0b:18"));
   ...
   dev1_0->SetAddress (Mac48Address("7f:67:12:b2:0b:19"));
   ...
   dev1_1->SetAddress (Mac48Address("7f:67:12:b2:0b:1a"));
   ...
   dev1_2->SetAddress (Mac48Address("7f:67:12:b2:0b:1c"));
   ...
   dev1_3->SetAddress (Mac48Address("7f:67:12:b2:0b:1e"));
   ...
   dev2_0->SetAddress (Mac48Address("7f:67:12:b2:0b:1b"));
   ...
   dev2_1->SetAddress (Mac48Address("7f:67:12:b2:0b:20"));
   ...
   dev2_2->SetAddress (Mac48Address("7f:67:12:b2:0b:22"));
   ...
   dev2_3->SetAddress (Mac48Address("7f:67:12:b2:0b:24"));
   ...
   dev3_0->SetAddress (Mac48Address("7f:67:12:b2:0b:1d"));
   ...
   dev3_1->SetAddress (Mac48Address("7f:67:12:b2:0b:21"));
   ...
   dev3_2->SetAddress (Mac48Address("7f:67:12:b2:0b:26"));
   ...
   dev4_0->SetAddress (Mac48Address("7f:67:12:b2:0b:23"));
   ...
   dev5_0->SetAddress (Mac48Address("7f:67:12:b2:0b:27"));
   ...
   dev6_0->SetAddress (Mac48Address("7f:67:12:b2:0b:25"));
   ...
   dev7_0->SetAddress (Mac48Address("7f:67:12:b2:0b:1f"));
   ...
   click4->SetClickFile(path + "00000005.conf");
   ...
   click5->SetClickFile(path + "00000006.conf");
   ...
   click6->SetClickFile(path + "00000007.conf");
   ...
   click7->SetClickFile(path + "00000008.conf");
